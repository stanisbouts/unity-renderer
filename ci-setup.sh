...
if [ -z "$UNITY_LICENSE_CONTENT_2020_3_BASE64_TEMP" ]; then
  echo 'UNITY_LICENSE_CONTENT_2020_3_BASE64_TEMP not present. License won''t be configured'
else
  LICENSE=$(echo "${UNITY_LICENSE_CONTENT_2020_3_BASE64_TEMP}" | base64 -di | tr -d '\r')
