...
namespace DCL.Builder
{
    internal class SectionScenesController : SectionBase, ISceneListener, ISectionHideContextMenuRequester
    {
        ...
        private readonly SectionScenesView view;
        ...
        public SectionScenesController() : this(
            Object.Instantiate(Resources.Load<SectionScenesView>(VIEW_PREFAB_PATH))
        ) { }

        public SectionScenesController(SectionScenesView view)
        {
            this.view = view;
