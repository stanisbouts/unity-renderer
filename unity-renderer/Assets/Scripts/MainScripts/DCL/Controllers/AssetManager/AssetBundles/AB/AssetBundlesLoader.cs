...
namespace DCL
{
    public class AssetBundlesLoader
    {
        ...
        private struct AssetBundleInfo
        {
            ...
            public AssetBundleInfo(Asset_AB asset, AssetBundle assetBundle, Transform containerTransform, Action onSuccess, Action<string> onFail)
            {
                this.asset = asset;
        ...
        public void MarkAssetBundleForLoad(Asset_AB asset, AssetBundle assetBundle, Transform containerTransform, Action onSuccess, Action<string> onFail)
        {
        ...
        private IEnumerator LoadAssetBundle(AssetBundleInfo assetBundleInfo)
        {
            ...
            {
                assetBundleInfo.onFail?.Invoke("asset bundle is null");
                yield break;
            }
